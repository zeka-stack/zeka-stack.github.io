...
关于 `maven-assembly-plugin` 的 `outputTimestamp` 配置的详细说明可参考 [[arco-meta/arco-maven-plugin/arco-assist-maven-plugin/detail-reproducible-build|可重现构建说明文档]].
...
[arco-meta/arco-maven-plugin/arco-assist-maven-plugin](https://github.com/dong4j/zeka.stack/tree/main/arco-meta/arco-maven-plugin/arco-assist-maven-plugin)

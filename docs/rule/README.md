...
目前 JetBrains 家的所有产品全线支持中文, 只需要下载官方中文语言包即可, 笔者推荐使用中文包 (会有种发现新大陆的感觉).
...
以上是笔者意见, 大家随意选择, 如果以后需要帮你在本地处理 IDEA 的问题, 请先安装汉化包.
...
下面对 [这篇文档](../plugin/README.md) 进行了补充, 并推荐几个笔者经常使用到的插件, 或者你们也有趁手的插件都可以分享出来.
...
笔者认为代码规范是在 **编码过程中去下意识遵守的** , 而不是因为项目工期紧就去忽略这一项工作, 后期再花几天时间去改代码格式, 请一定要记住这个逻辑.

...
| 模块                               | 功能描述                       | 依赖关系       |
|----------------------------------|----------------------------|------------|
| [[blen-kernel-common/index       | blen-kernel-common]]       | 基础工具类和通用功能 | 基础模块 |
| [[blen-kernel-dependencies/index | blen-kernel-dependencies]] | 依赖版本管理     | 父模块  |

### 功能模块

| 模块                                | 功能描述                        | 依赖关系      |
|-----------------------------------|-----------------------------|-----------|
| [[blen-kernel-auth/index          | blen-kernel-auth]]          | JWT 认证和授权 | common     |
| [[blen-kernel-validation/index    | blen-kernel-validation]]    | 参数验证和校验   | common     |
| [[blen-kernel-web/index           | /blen-kernel-web]]          | Web 应用支持  | common     |
| [[blen-kernel-autoconfigure/index | blen-kernel-autoconfigure]] | 自动配置      | validation |

### 工具模块

| 模块                            | 功能描述                    | 依赖关系    |
|-------------------------------|-------------------------|---------|
| [[blen-kernel-generator/index | blen-kernel-generator]] | 代码生成工具  | common |
| [[blen-kernel-test/index      | blen-kernel-test]]      | 测试工具和注解 | common |
| [[blen-kernel-notify/index    | blen-kernel-notify]]    | 消息通知    | common |
| [[blen-kernel-spi/index       | blen-kernel-spi]]       | 服务提供者接口 | common |

### 扩展模块

| 模块                         | 功能描述                 | 依赖关系    |
|----------------------------|----------------------|---------|
| [[blen-kernel-tracer/index | blen-kernel-tracer]] | 链路追踪    | common |
| [[blen-kernel-extend/index | blen-kernel-extend]] | 第三方组件集成 | common |
...
[blen-kernel](https://github.com/dong4j/zeka.stack/tree/main/blen-kernel)
